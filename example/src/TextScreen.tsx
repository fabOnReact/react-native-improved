...
import {AndroidPatch} from './AndroidPatch';

export function TextScreen() {
  return (
    <ScrollView>
      <RNTesterBlock title="Android Patch">
        <AndroidPatch />
      </RNTesterBlock>
      <TextExample />
      <Text style={styles.header}>Text `alignItems: 'baseline'` style</Text>
      <TextBaseLineLayoutExample />
      <Text style={styles.header}>'Selectable Text'</Text>
      <View>
        <Text style={{ userSelect: 'auto' }}>Text element is selectable</Text>
      </View>
      <Text style={styles.header}>'Text alignment'</Text>
      <View>
